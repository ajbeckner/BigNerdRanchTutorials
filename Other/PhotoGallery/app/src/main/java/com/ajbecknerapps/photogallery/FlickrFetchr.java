...
public class FlickrFetchr {
    ...
    private static final String API_KEY = "d3c9045de29a004270328764bad009c0";
    ...
    byte[] getUrlBytes(String urlSpec) throws IOException {
        ...
        try {
            ...
            if (connection.getResponseCode() != HttpURLConnection.HTTP_OK) {
                Log.d(TAG, "responsecode fail:" + connection.getResponseCode());
                Log.d(TAG, "HttpURLConnection.HTTP_OK :" + HttpURLConnection.HTTP_OK);
                return null;
            }


            Log.d(TAG, "responsecode success :" + connection.getResponseCode());
            int bytesRead = 0;
